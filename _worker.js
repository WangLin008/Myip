...
// Variables
const rootDomain = "jeizek.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "premium-myip"; // Ganti dengan nama workers kalian
...
const DNS_SERVER_ADDRESS = "https://8.8.8.8/dns-query";
